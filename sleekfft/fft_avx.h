    ...
    inline void fft(const f64 *wr, const f64* wi, f64 *xr, f64 *xi, const usize k) {
        ...
        for (usize u = (k & 1) + 1, v = 1ULL << ((k & ~1ULL) - 2); v >= 4; u <<= 2, v >>= 2) {
            ...
            for (usize h = 1; h < u; ++h) {
                ...
                const f64x4 w3r = w1r * w2r - w1i * w2i, w3i = w1r * w2i + w1i * w2r;
                ...
                for (usize i0 = h * 4 * v, i1 = i0 + v, i2 = i1 + v, i3 = i2 + v, ie = i1; i0 < ie; i0 += 4, i1 += 4, i2 += 4, i3 += 4) {
                    ...
                    const f64x4 x1r = t1r * w1r - t1i * w1i, x1i = t1r * w1i + t1i * w1r;
                    const f64x4 x2r = t2r * w2r - t2i * w2i, x2i = t2r * w2i + t2i * w2r;
                    const f64x4 x3r = t3r * w3r - t3i * w3i, x3i = t3r * w3i + t3i * w3r;
        ...
        for (usize u = k < 4 ? 0 : 1ULL << (k - 4), v = 4; u; u >>= 2, v <<= 2) {
            ...
            for (usize h = 1; h < u; ++h) {
                ...
                for (usize i0 = h * 4 * v, i1 = i0 + v, i2 = i1 + v, i3 = i2 + v, ie = i1; i0 < ie; i0 += 4, i1 += 4, i2 += 4, i3 += 4) {
                    ...
                    _mm256_storeu_pd(xr + i1, z1r * w1r - z1i * w1i); _mm256_storeu_pd(xi + i1, z1r * w1i + z1i * w1r);
                    _mm256_storeu_pd(xr + i2, z2r * w2r - z2i * w2i); _mm256_storeu_pd(xi + i2, z2r * w2i + z2i * w2r);
                    _mm256_storeu_pd(xr + i3, z3r * w3r - z3i * w3i); _mm256_storeu_pd(xi + i3, z3r * w3i + z3i * w3r);
                }
            }
        }
        if (k & 1) {
